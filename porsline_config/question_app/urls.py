...
questionnaire_router.register('numberanswer-questions', views.NumberAnswerQuestionViewSet, basename='numberanswer_questions')
questionnaire_router.register('integerrange-questions', views.IntegerRangeQuestionViewSet, basename='integerrange_questions')
questionnaire_router.register('integerselective-questions', views.IntegerSelectiveQuestionViewSet, basename='integerselective_qustions')
questionnaire_router.register('picture-questions', views.IntegerSelectiveQuestionViewSet, basename='integerselective_qustions')
