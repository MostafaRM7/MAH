...
from question_app.models import Questionnaire, QuestionGroup
...
class TestListingQuestion:
    def test_if_user_anonymous_returns_401(self, api_client):
        ...
        res = api_client.get(f'/question-api/questionnaires/{q.uuid}/question-groups/')
...
class TestGettingQuestion:
    def test_if_user_anonymous_returns_401(self, api_client):
        ...
        q = baker.make(QuestionGroup, questionnaire=qn)

        res = api_client.get(f'/question-api/questionnaires/{qn.uuid}/question-groups/{q.id}/')
...
class TestCreatingQuestion:
    def test_if_user_is_anonymous_returns_401(self, api_client):
        ...
        res = api_client.post(f'/question-api/questionnaires/{q.uuid}/question-groups/', {})
    ...
    def test_if_user_is_not_owner_of_questionnaire_returns_403(self, api_client, authenticate):
        ...
        res = api_client.post(f'/question-api/questionnaires/{qn.uuid}/question-groups/', {})
    ...
    def test_if_user_is_allowed_and_data_valid_returns_201(self, api_client, authenticate):
        ...
        res = api_client.post(f'/question-api/questionnaires/{qn.uuid}/question-groups/', VALID_DATA, format='json')
    ...
    def test_if_user_allowed_and_invalid_data_returns_400(self, api_client, authenticate):
        ...
        res = api_client.post(f'/question-api/questionnaires/{qn.uuid}/question-groups/', {"a": "a"})
...
class TestUpdatingQuestion:
    def test_if_user_is_anonymous_returns_401(self, api_client):
        q = baker.make(Questionnaire)
        oq = baker.make(QuestionGroup, questionnaire=q)

        res = api_client.patch(f'/question-api/questionnaires/{q.uuid}/question-groups/{oq.id}/', {})
    ...
    def test_if_user_is_not_owner_of_questionnaire_returns_403(self, api_client, authenticate):
        ...
        uo = baker.make(get_user_model())
        qn = baker.make(Questionnaire, owner=uo)
        oq = baker.make(QuestionGroup, questionnaire=qn)

        res = api_client.patch(f'/question-api/questionnaires/{qn.uuid}/question-groups/{oq.id}/', {})
