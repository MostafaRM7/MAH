...
class TestListingQuestion:
    def test_if_user_anonymous_returns_401(self, api_client):
        ...
        res = api_client.get(f'/question-api/questionnaires/{q.uuid}/optional-questions/')
...
class TestGettingQuestion:
    def test_if_user_anonymous_returns_401(self, api_client):
        ...
        q = baker.make(OptionalQuestion, questionnaire=qn)

        res = api_client.get(f'/question-api/questionnaires/{qn.uuid}/optional-questions/{q.id}/')
...
class TestCreatingQuestion:
    def test_if_user_is_anonymous_returns_401(self, api_client):
        ...
        res = api_client.post(f'/question-api/questionnaires/{q.uuid}/optional-questions/', {})
    ...
    def test_if_user_is_not_owner_of_questionnaire_returns_403(self, api_client, authenticate):
        ...
        res = api_client.post(f'/question-api/questionnaires/{qn.uuid}/optional-questions/', {})
    ...
    def test_if_user_allowed_and_invalid_data_returns_400(self, api_client, authenticate):
        ...
        res = api_client.post(f'/question-api/questionnaires/{qn.uuid}/optional-questions/', {"a": "a"})
...
class TestUpdatingQuestion:
    def test_if_user_is_anonymous_returns_401(self, api_client):
        q = baker.make(Questionnaire)
        oq = baker.make(OptionalQuestion, questionnaire=q)

        res = api_client.patch(f'/question-api/questionnaires/{q.uuid}/optional-questions/{oq.id}/', {})
    ...
    def test_if_user_is_not_owner_of_questionnaire_returns_403(self, api_client, authenticate):
        ...
        uo = baker.make(get_user_model())
        qn = baker.make(Questionnaire, owner=uo)
        oq = baker.make(OptionalQuestion, questionnaire=qn)

        res = api_client.patch(f'/question-api/questionnaires/{qn.uuid}/optional-questions/{oq.id}/', {})
