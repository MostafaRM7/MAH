...
class TestListingQuestion:
    def test_if_user_anonymous_returns_401(self, api_client):
        ...
        response = api_client.get(f'/question-api/questionnaires/{questionnaire.uuid}/picture-questions/')
...
class TestGettingQuestion:
    def test_if_user_anonymous_returns_401(self, api_client):
        questionnaire = baker.make(Questionnaire)
        question = baker.make(PictureFieldQuestion, questionnaire=questionnaire)

        response = api_client.get(f'/question-api/questionnaires/{questionnaire.uuid}/picture-questions/{question.id}/')
...
class TestCreatingQuestion:
    def test_if_user_is_anonymous_returns_401(self, api_client):
        ...
        response = api_client.post(f'/question-api/questionnaires/{question.uuid}/picture-questions/', {})
    ...
    def test_if_user_is_not_owner_of_questionnaire_returns_403(self, api_client, authenticate):
        ...
        response = api_client.post(f'/question-api/questionnaires/{questionnaire.uuid}/picture-questions/', {})
    ...
    def test_if_user_is_allowed_and_data_valid_returns_201(self, api_client, authenticate):
        ...
        response = api_client.post(f'/question-api/questionnaires/{questionnaire.uuid}/picture-questions/', VALID_DATA, format='json')
    ...
    def test_if_user_allowed_and_invalid_data_returns_400(self, api_client, authenticate):
        ...
        response = api_client.post(f'/question-api/questionnaires/{questionnaire.uuid}/picture-questions/', {"a": "a"})
...
class TestUpdatingQuestion:
    def test_if_user_is_anonymous_returns_401(self, api_client):
        ...
        response = api_client.patch(f'/question-api/questionnaires/{questionnaire.uuid}/picture-questions/{question.id}/', {})
