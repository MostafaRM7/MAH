    ...
    def me(self, request):
        ...
        if request.method == 'GET':
            serializer = ProfileSerializer(
                Profile.objects.prefetch_related('prefered_districts', 'prefered_districts__city', 'prefered_districts__city__province', 'prefered_districts__city__province__country', 'resume__skills',
