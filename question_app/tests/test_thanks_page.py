...
class TestListingPage:
    def test_if_user_is_anonymous_returns_401(self, api_client):
        ...
        response = api_client.get(f'/question-api/questionnaires/{questionnaire.uuid}/thanks-pages/')
...
class TestRetrievingPage:
    def test_if_user_is_anonymous_returns_401(self, api_client):
        questionnaire = baker.make(Questionnaire)
        thanks_page = baker.make(ThanksPage, questionnaire=questionnaire)

        response = api_client.get(f'/question-api/questionnaires/{questionnaire.uuid}/thanks-pages/{thanks_page.id}/')
...
class TestCreatingPage:
    def test_if_user_is_anonymous_returns_401(self, api_client):
        ...
        response = api_client.post(f'/question-api/questionnaires/{questionnaire.uuid}/thanks-pages/', VALID_DATA, format='json')
    ...
    def test_if_user_allowed_and_data_is_invalid_returns_400(self, api_client, authenticate):
        ...
        response = api_client.post(f'/question-api/questionnaires/{questionnaire.uuid}/thanks-pages/', {}, format='json')
...
class TestUpdatingPage:
    def test_if_user_is_anonymous_returns_401(self, api_client):
        ...
        response = api_client.patch(f'/question-api/questionnaires/{questionnaire.uuid}/thanks-pages/{thanks_page.id}/', data, format='json')
    ...
    def test_if_user_is_owner_returns_200(self, api_client, authenticate):
        ...
        response = api_client.patch(f'/question-api/questionnaires/{questionnaire.uuid}/thanks-pages/{thanks_page.id}/', data)
...
class TestDeletingPage:
    def test_if_user_is_anonymous_returns_401(self, api_client):
        ...
        response = api_client.delete(f'/question-api/questionnaires/{questionnaire.uuid}/thanks-pages/{thanks_page.id}/')
