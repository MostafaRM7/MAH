...
class TestCreatingQuestion:
    ...
    def test_if_user_is_allowed_and_data_valid_returns_201(self, api_client, authenticate):
        ...
        response = api_client.post(f'/question-api/questionnaires/{questionnaire.uuid}/picture-questions/', VALID_DATA,
                                   format='json')
...
class TestUpdatingQuestion:
    def test_if_user_is_anonymous_returns_401(self, api_client):
        ...
        response = api_client.patch(
            f'/question-api/questionnaires/{questionnaire.uuid}/picture-questions/{question.id}/', {})
