...
def copy_template(template:Questionnaire, owner:Profile):
    groups = {}
    folder = owner.folders.last() if owner.folders.exists() else Folder.objects.create(name='پیش فرض', owner=owner)
